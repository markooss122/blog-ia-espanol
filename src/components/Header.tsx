      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-between items-center h-14">
          ...
          <nav className="flex items-center gap-1">
            ...
            <Link href="/sobre-nosotros" className="text-sm text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 px-3 py-1.5 rounded-md transition-colors">
              Sobre nosotros
            </Link>
            <Link href="/contacto" className="text-sm text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 px-3 py-1.5 rounded-md transition-colors">
              Contacto
            </Link>
            <Link href="/#newsletter" className="ml-2 text-sm bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1.5 rounded-md transition-colors font-medium">
              Suscribirse
            </Link>
          </nav>
        </div>
